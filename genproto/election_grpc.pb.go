...
const (
	ElectionService_CreateElection_FullMethodName  = "/voting_proto.ElectionService/CreateElection"
	ElectionService_DeleteElection_FullMethodName  = "/voting_proto.ElectionService/DeleteElection"
	ElectionService_UpdateElection_FullMethodName  = "/voting_proto.ElectionService/UpdateElection"
	ElectionService_GetByIdElection_FullMethodName = "/voting_proto.ElectionService/GetByIdElection"
	ElectionService_GetAllElections_FullMethodName = "/voting_proto.ElectionService/GetAllElections"
)
...
func (c *electionServiceClient) CreateElection(ctx context.Context, in *Election, opts ...grpc.CallOption) (*Void, error) {
	...
	out := new(Void)
	err := c.cc.Invoke(ctx, ElectionService_CreateElection_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *electionServiceClient) DeleteElection(ctx context.Context, in *ById, opts ...grpc.CallOption) (*Void, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Void)
	err := c.cc.Invoke(ctx, ElectionService_DeleteElection_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *electionServiceClient) UpdateElection(ctx context.Context, in *Election, opts ...grpc.CallOption) (*Void, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Void)
	err := c.cc.Invoke(ctx, ElectionService_UpdateElection_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *electionServiceClient) GetByIdElection(ctx context.Context, in *ById, opts ...grpc.CallOption) (*Election, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Election)
	err := c.cc.Invoke(ctx, ElectionService_GetByIdElection_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *electionServiceClient) GetAllElections(ctx context.Context, in *Filter, opts ...grpc.CallOption) (*GetAllElection, error) {
	...
	err := c.cc.Invoke(ctx, ElectionService_GetAllElections_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _ElectionService_GetByIdElection_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ElectionService_GetByIdElection_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _ElectionService_GetAllElections_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ElectionService_GetAllElections_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
