...
const (
	PublicService_CreatePublic_FullMethodName  = "/voting_proto.PublicService/CreatePublic"
	PublicService_DeletePublic_FullMethodName  = "/voting_proto.PublicService/DeletePublic"
	PublicService_UpdatePublic_FullMethodName  = "/voting_proto.PublicService/UpdatePublic"
	PublicService_GetByIdPublic_FullMethodName = "/voting_proto.PublicService/GetByIdPublic"
	PublicService_GetAllPublics_FullMethodName = "/voting_proto.PublicService/GetAllPublics"
)
...
func (c *publicServiceClient) DeletePublic(ctx context.Context, in *ById, opts ...grpc.CallOption) (*Void, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Void)
	err := c.cc.Invoke(ctx, PublicService_DeletePublic_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *publicServiceClient) GetByIdPublic(ctx context.Context, in *ById, opts ...grpc.CallOption) (*Public, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Public)
	err := c.cc.Invoke(ctx, PublicService_GetByIdPublic_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *publicServiceClient) GetAllPublics(ctx context.Context, in *Filter, opts ...grpc.CallOption) (*GetAllPublic, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetAllPublic)
	err := c.cc.Invoke(ctx, PublicService_GetAllPublics_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedPublicServiceServer) GetAllPublics(context.Context, *Filter) (*GetAllPublic, error) {
...
func _PublicService_GetAllPublics_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PublicServiceServer).GetAllPublics(ctx, req.(*Filter))
	}
	return interceptor(ctx, in, info, handler)
}
