...
const (
	PartyService_CreateParty_FullMethodName  = "/voting_proto.PartyService/CreateParty"
	PartyService_DeleteParty_FullMethodName  = "/voting_proto.PartyService/DeleteParty"
	PartyService_UpdateParty_FullMethodName  = "/voting_proto.PartyService/UpdateParty"
	PartyService_GetByIdParty_FullMethodName = "/voting_proto.PartyService/GetByIdParty"
	PartyService_GetAllPartys_FullMethodName = "/voting_proto.PartyService/GetAllPartys"
)
...
type PartyServiceClient interface {
	...
	GetAllPartys(ctx context.Context, in *Filter, opts ...grpc.CallOption) (*GetAllParty, error)
}
...
func (c *partyServiceClient) GetByIdParty(ctx context.Context, in *ById, opts ...grpc.CallOption) (*Party, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Party)
	err := c.cc.Invoke(ctx, PartyService_GetByIdParty_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *partyServiceClient) GetAllPartys(ctx context.Context, in *Filter, opts ...grpc.CallOption) (*GetAllParty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetAllParty)
	err := c.cc.Invoke(ctx, PartyService_GetAllPartys_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type PartyServiceServer interface {
	...
	GetAllPartys(context.Context, *Filter) (*GetAllParty, error)
...
func (UnimplementedPartyServiceServer) GetAllPartys(context.Context, *Filter) (*GetAllParty, error) {
...
func _PartyService_GetByIdParty_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: PartyService_GetByIdParty_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _PartyService_GetAllPartys_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: PartyService_GetAllPartys_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PartyServiceServer).GetAllPartys(ctx, req.(*Filter))
	}
	return interceptor(ctx, in, info, handler)
}
